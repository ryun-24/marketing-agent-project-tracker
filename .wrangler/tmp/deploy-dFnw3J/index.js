    ...
    <script>
        ...
        function renderDetail(project) {
            ...
            let blockersHtml = project.blockers?.length
                ...
                \`).join('')
                : '<p style="color:#718096;font-style:italic;">No open blockers \u{1F389}</p>';
            ...
            document.getElementById('detailBody').innerHTML = \`
                <div class="detail-section">
                    ...
                    <div style="display:flex;gap:15px;margin-bottom:15px;flex-wrap:wrap;">
                        <span class="status-badge \${statusClass}">\${statusLabel}</span>
                        <span style="color:#718096;">\u{1F4C1} \${escapeHtml(project.team || 'No team')}</span>
                        <span style="color:#718096;">\u{1F464} \${escapeHtml(project.owner || 'Unassigned')}</span>
                        \${links.length ? '<span style="color:#718096;">\u{1F517} ' + links.join(' \u2022 ') + '</span>' : ''}
                    </div>
                </div>
                
                <div class="detail-section">
                    <h3>\u{1F6A7} Blockers</h3>
                    \${blockersHtml}
                    <button class="btn-primary" style="margin-top:10px;" onclick="addBlocker()">+ Add Blocker</button>
                </div>
                
                <div class="detail-section">
                    <h3>\u{1F4DD} Updates & Next Steps</h3>
                    \${updatesHtml}
